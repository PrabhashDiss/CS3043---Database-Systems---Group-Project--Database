...
CREATE TABLE `account_relate` (
  `relate_from` char(10) NOT NULL,
  `relate_to` char(10) NOT NULL,
  PRIMARY KEY (`relate_to`,`relate_from`),
  KEY `relate_from` (`relate_from`),
  CONSTRAINT `account_relate_ibfk_1` FOREIGN KEY (`relate_from`) REFERENCES `account` (`account_number`),
  CONSTRAINT `account_relate_ibfk_2` FOREIGN KEY (`relate_to`) REFERENCES `account` (`account_number`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `account_relate` VALUES ('1082310654','4152179632'),('7094310654','7092310654');
...
INSERT INTO `account_type` VALUES (13,NULL,'6 months','f001','fd',NULL),(14,NULL,'1 year','f002','fd',NULL),(15,NULL,'3 years','f003','fd',NULL),(12,0,'child','s001','saving',5),(11,500,'teen','s002','saving',5),(10,1000,'adult','s003','saving',5),(13,1000,'senior','s004','saving',5);
...
INSERT INTO `borrower` VALUES ('c237','256548852');
...
INSERT INTO `loan_account` VALUES ('4152179632','108231064'),('1082310654','254897526'),('1082310654','256548852');
...
INSERT INTO `loan_payment` VALUES ('254897526',1,'13456','2014-11-21',2000,'',1,'remark_123'),('256548852',3,'16803','2022-10-14',1000,'',0,'remark_433');
...
CREATE TABLE `transaction` (
  ...
  `account_number_from` char(10) DEFAULT NULL,
  ...
  `account_number_to` char(10) DEFAULT NULL,
  PRIMARY KEY (`transaction_id`),
  KEY `account_number` (`account_number_from`),
  KEY `execution_branch_code` (`execution_branch_code`),
  CONSTRAINT `transaction_ibfk_1` FOREIGN KEY (`account_number_from`) REFERENCES `account` (`account_number`),
...
INSERT INTO `transaction` VALUES ('3332','2051271952','paying car rent',550000.00,'0003','2022-02-24 17:53:43','1082310654'),('3333','2051271952','paying car rent',100000000.00,'0003','2022-02-24 17:53:43','1082310654'),('3335','2051271952','paying car rent',100000000.00,'0003','2022-02-24 17:53:43','1082310654'),('3336','2051271952','paying car rent',100000000.00,'0003','2022-02-24 17:53:43','1082310654'),('3337','2051271952','paying car rent',100000000.00,'0003','2022-02-24 17:53:43','1082310654'),('3339','2051271952','paying car rent',10000000.00,'0003','2022-02-24 17:53:43','1082310654'),('3340','2051271952','paying car rent',10000000.00,'0003','2022-02-24 17:53:43','1082310654'),('3456','1082310654','paying house rent',3000.00,'0002','2015-03-05 07:04:00',NULL),('7332','2051271952','paying car rent',550000.00,'0001','2022-02-24 17:53:43','1082310654'),('7342','2051271952','paying car rent',550000.00,'0001','2022-02-24 17:53:43','1082310654'),('7752','2051271952','paying car rent',550000.00,'0003','2022-02-24 17:53:43','1082310654'),('7762','2051271952','paying car rent',550000.00,'0003','2022-02-24 17:53:43','1082310654');
...
INSERT INTO `users` VALUES ('a234','123','customer',NULL,NULL),('u123','123','manager',NULL,'2100');
...
-- Dump completed on 2023-01-13 20:51:35
